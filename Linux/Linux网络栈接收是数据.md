...
本文尝试从技术研发与工程实践的角度，在原理与实现、监控告警、配置调优来介绍内核5.10网络栈
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/l2-protocols.png)
...
网卡通过 PCIe 连接到 CPU，简单的场景就是 NIC 直连 CPU 上自带的 PCIe， 复杂的场景（比如 8 卡 GPU 主机）还会引入额外的 PCIe Switch 芯片，因为机器上设备太多， PCIe 接口不够用了。

![img](https://arthurchiao.art/assets/img/gpu-notes/8x-a100-node-hw-topo.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/pci-probe.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/mlx5e_init.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/dma-ringbuffer.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/irq-and-napi-poll.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/cpu-schedule-threads.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/run_ksoftirqd.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/uu_do_softirq.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/net_rx_action.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/napi_gro_receive.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/netif_receive_skb_list_internal.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/inet_init.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/l3-processing-stack.png)
...
![img](https://arthurchiao.art/assets/img/linux-net-stack/uu_udp4_lib_rcv.png)
...
DMA engine 是一个硬件，允许 CPU 将大的**数据复制操作下放（offload）给它**，

- 优点：**将 CPU 从复制数据中解放出来**，去做其他事情。

  使用 DMA 引擎需要代码做适配，调用它的 API。Linux 内核有一个通用的 DMA 引擎 接口，DMA engine 驱动实现这个接口即可。更多信息参考内核文档 [Documentation/driver-api/dmaengine](https://github.com/torvalds/linux/blob/v5.10/Documentation/driver-api/dmaengine)。
